...
> O `Makefile` assume que as pastas `compiladores-corretor-automatico/` e `casos-de-teste/` estão no diretório-pai deste repositório. Esses caminhos (e o RA do grupo) podem ser sobrescritos, ex.: `make test-t4 CASOS=/caminho/para/casos-de-teste`.
